...
RUN apt-get update -qq && apt-get install -y build-essential libicu-dev libzip-dev libpng-dev libonig-dev libpq-dev zip unzip wget nano curl git && apt-get clean && rm -rf /var/lib/apt/lists/*
